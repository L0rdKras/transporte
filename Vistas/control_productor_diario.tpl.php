...
<div class="datos_ingreso" id="data_busqueda">
	<p>
		Seleccione el Productor a Consultar
		<select name="productor" id="productor_consultar">
			<option value=""></option>
			<?php
	...
	<p>
		<button id="btn_busca_diario_productor" class="css_btn_busca">Buscar</button>
		<button id="btn_imprime_diario_productor" class="css_btn_imprime">Imprime</button>
	</p>
</div>
